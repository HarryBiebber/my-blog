  ...
  return (
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-100">
      <div className="max-w-[1440px] mx-auto px-6 h-16 flex justify-between items-center">
        {/* Left: Brand - Captain America Shield Style Icon + "小田" */}
      ...
      {/* Mobile Menu Overlay */}
      {isMenuOpen && (
        <div className="lg:hidden absolute top-16 left-0 w-full bg-white border-b border-gray-200 p-4 shadow-xl flex flex-col space-y-4">
